...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/topico/**").hasRole("USUARIO")
		.antMatchers(HttpMethod.POST, "/topico/**").hasRole("USUARIO")
		.antMatchers(HttpMethod.GET, "/criarpagamento/**").hasRole("USUARIO")
		.antMatchers(HttpMethod.POST, "/criarpagamento/**").hasRole("USUARIO")
		.antMatchers(HttpMethod.GET, "/adicionarfundos/**").hasRole("USUARIO")
		.antMatchers(HttpMethod.POST, "/adicionarfundos/**").hasRole("USUARIO")
		.antMatchers(HttpMethod.GET, "/consultasaldo/**").hasRole("USUARIO")
